...
describe(`Payments Service ListOrderPaymentsApi DbListOrderPaymentsClient tests`, () => {
   ...
   ************************************************************/
  it(`does not throw if the input ListOrderPaymentsCommand is valid`, async () => {
    const mockDdbDocClient = buildMockDdbDocClient_resolves()
    const dbListOrderPaymentsClient = new DbListOrderPaymentsClient(mockDdbDocClient)
    await expect(dbListOrderPaymentsClient.listOrderPayments(mockListOrderPaymentsCommand)).resolves.not.toThrow()
  })
  ...
  it(`throws a non-transient InvalidArgumentsError if the input
    ...
    const resultPromise = dbListOrderPaymentsClient.listOrderPayments(mockTestCommand)
  ...
  it(`throws a transient UnrecognizedError if DynamoDBDocumentClient.send throws an
    ...
    const dbListOrderPaymentsClient = new DbListOrderPaymentsClient(mockDdbDocClient)
    const resultPromise = dbListOrderPaymentsClient.listOrderPayments(mockListOrderPaymentsCommand)
   ...
   ************************************************************/
  it(`returns the expected empty OrderPaymentData[] if DynamoDBDocumentClient.send
  ...
  it(`returns the expected OrderPaymentData[] if DynamoDBDocumentClient.send returns
