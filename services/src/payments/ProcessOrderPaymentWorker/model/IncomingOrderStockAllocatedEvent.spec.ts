...
describe(`Payments Service ProcessOrderPaymentWorker IncomingOrderStockAllocatedEvent
  ...
  it(`does not throw if the input EventBridgeEvent is valid`, () => {
    ...
    expect(() => IncomingOrderStockAllocatedEvent.validateAndBuild(mockEventBridgeEvent)).not.toThrow()
  })
  ...
  it(`throws a non-transient InvalidArgumentsError if the input EventBridgeEvent is
    ...
    const testingFunc = () => IncomingOrderStockAllocatedEvent.validateAndBuild(mockEventBridgeEvent)
   ...
   ************************************************************/
  it(`returns the expected IncomingOrderStockAllocatedEvent if the execution path is
      successful`, () => {
    const mockIncomingOrderStockAllocatedEvent = buildMockIncomingOrderStockAllocatedEvent()
    const mockEventBridgeEvent = buildMockEventBridgeEvent(mockIncomingOrderStockAllocatedEvent)
