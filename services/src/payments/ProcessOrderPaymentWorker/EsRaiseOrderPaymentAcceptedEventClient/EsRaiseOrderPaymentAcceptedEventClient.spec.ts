...
describe(`Payments Service ProcessOrderPaymentApi EsRaiseOrderPaymentAcceptedEventClient
          tests`, () => {
  /*
   *
   *
   ...
   ************************************************************/
  it(`does not throw if the input OrderPaymentAcceptedEvent is valid`, async () => {
    const mockDdbDocClient = buildMockDdbDocClient_resolves()
    const esRaiseOrderPaymentAcceptedEventClient = new EsRaiseOrderPaymentAcceptedEventClient(mockDdbDocClient)
    const resultPromise =
      esRaiseOrderPaymentAcceptedEventClient.raiseOrderPaymentAcceptedEvent(mockOrderPaymentAcceptedEvent)
  ...
  it(`throws a non-transient InvalidArgumentsError if the input
    ...
    const resultPromise = esRaiseOrderPaymentAcceptedEventClient.raiseOrderPaymentAcceptedEvent(mockTestEvent)
