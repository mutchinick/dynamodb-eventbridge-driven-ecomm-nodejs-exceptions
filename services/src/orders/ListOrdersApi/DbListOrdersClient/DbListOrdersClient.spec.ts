...
describe(`Orders Service ListOrdersApi DbListOrdersClient tests`, () => {
  ...
  it(`throws a non-transient InvalidArgumentsError if the input ListOrdersCommand.queryData is undefined`, async () => {
    const mockDdbDocClient = buildMockDdbDocClient_resolves()
    const dbListOrdersClient = new DbListOrdersClient(mockDdbDocClient)
    const mockTestCommand = buildMockListOrdersCommand({})
  ...
  it(`throws a non-transient InvalidArgumentsError if the input ListOrdersCommand.queryData is null`, async () => {
    const mockDdbDocClient = buildMockDdbDocClient_resolves()
    const dbListOrdersClient = new DbListOrdersClient(mockDdbDocClient)
    const mockTestCommand = buildMockListOrdersCommand({})
