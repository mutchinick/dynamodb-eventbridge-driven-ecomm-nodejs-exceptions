...
describe(`Inventory Service CompleteOrderPaymentAcceptedWorker
  ...
  it(`does not throw if the input EventBridgeEvent is valid`, () => {
    ...
    expect(() => IncomingOrderPaymentAcceptedEvent.validateAndBuild(mockEventBridgeEvent)).not.toThrow()
  })
  ...
  it(`throws a non-transient InvalidArgumentsError if the input EventBridgeEvent is
    ...
    const testingFunc = () => IncomingOrderPaymentAcceptedEvent.validateAndBuild(mockEventBridgeEvent)
   ...
   ************************************************************/
  it(`returns the expected IncomingOrderPaymentAcceptedEvent if the execution path is
      successful`, () => {
    const mockIncomingOrderPaymentAcceptedEvent = buildMockIncomingOrderPaymentAcceptedEvent()
    const mockEventBridgeEvent = buildMockEventBridgeEvent(mockIncomingOrderPaymentAcceptedEvent)
