...
function buildMockListSkusApiService_resolves(): IListSkusApiService {
  return { listSkus: jest.fn().mockResolvedValue(mockServiceOutput) }
}

function buildMockListSkusApiService_throws(error?: unknown): IListSkusApiService {
...
describe(`Warehouse Service ListSkusApi ListSkusApiController tests`, () => {
  ...
  it(`responds with 500 Internal Server Error if ListSkusApiService.listSkus throws an unwrapped Error`, async () => {
