...
describe(`Warehouse Service AllocateOrderStockApi OrderStockAllocatedEvent tests`, () => {
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.units < 1`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
   ...
   ************************************************************/
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.price is undefined`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.price is null`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.price < 0`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.price is not a number`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
   ...
   ************************************************************/
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.userId is undefined`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.userId is null`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.userId is empty`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.userId is blank`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
    mockOrderStockAllocatedEventInput.userId = '      '
    const testingFunc = () => OrderStockAllocatedEvent.validateAndBuild(mockOrderStockAllocatedEventInput)
    expect(testingFunc).toThrow(InvalidArgumentsError)
  ...
  it(`throws a non-transient InvalidArgumentsError if the input OrderStockAllocatedEventInput.userId length < 4`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
   ...
   ************************************************************/
  it(`returns the expected OrderStockAllocatedEvent if the execution path is successful`, () => {
    const mockOrderStockAllocatedEventInput = buildMockOrderStockAllocatedEventInput()
