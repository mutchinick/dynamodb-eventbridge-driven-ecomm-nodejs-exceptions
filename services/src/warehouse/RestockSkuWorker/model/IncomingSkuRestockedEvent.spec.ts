...
describe(`Warehouse Service RestockSkuWorker IncomingSkuRestockedEvent tests`, () => {
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.eventName is null`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.eventName is empty`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.eventName is blank`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
    mockIncomingSkuRestockedEvent.eventName = '      ' as never
    const mockEventBridgeEvent = buildMockEventBrideEvent(mockIncomingSkuRestockedEvent)
    const testingFunc = () => IncomingSkuRestockedEvent.validateAndBuild(mockEventBridgeEvent)
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.createdAt is null`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.createdAt is empty`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.createdAt is blank`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
    mockIncomingSkuRestockedEvent.createdAt = '      ' as never
    const mockEventBridgeEvent = buildMockEventBrideEvent(mockIncomingSkuRestockedEvent)
    const testingFunc = () => IncomingSkuRestockedEvent.validateAndBuild(mockEventBridgeEvent)
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.createdAt length < 4`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.updatedAt is null`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.updatedAt is empty`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.updatedAt is blank`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
    mockIncomingSkuRestockedEvent.updatedAt = '      ' as never
    const mockEventBridgeEvent = buildMockEventBrideEvent(mockIncomingSkuRestockedEvent)
    const testingFunc = () => IncomingSkuRestockedEvent.validateAndBuild(mockEventBridgeEvent)
  ...
  it(`throws a non-transient InvalidArgumentsError if the input IncomingSkuRestockedEvent.updatedAt length < 4`, () => {
    const mockIncomingSkuRestockedEvent = buildMockIncomingSkuRestockedEvent()
