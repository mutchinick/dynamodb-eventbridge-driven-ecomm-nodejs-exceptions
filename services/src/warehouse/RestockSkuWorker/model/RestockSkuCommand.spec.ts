...
describe(`Warehouse Service RestockSkuWorker RestockSkuCommand tests`, () => {
  ...
  //
  it(`throws an InvalidArgumentsError if the input RestockSkuCommandInput.is undefined`, () => {
    const mockRestockSkuCommandInput: RestockSkuCommandInput = undefined
    expect(() => RestockSkuCommand.validateAndBuild(mockRestockSkuCommandInput)).toThrow(InvalidArgumentsError)
  })

  it(`throws an InvalidArgumentsError if the input RestockSkuCommandInput.is null`, () => {
